/* TypeScript file generated from OpenCore.res by genType. */
/* eslint-disable import/first */


import {useAuthState as useAuthStateNotChecked} from 'react-firebase-hooks/auth';

// In case of type error, check the type of 'useAuthState' in 'OpenCore.re' and 'react-firebase-hooks/auth'.
